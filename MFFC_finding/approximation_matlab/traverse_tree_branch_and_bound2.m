function tree_node_obj = traverse_tree_branch_and_bound2(tree_node_obj)
    error_bound = Inf;
    if(tree_node_obj.is_leaf == 1)
        ...
        for i=length(tree_node_obj.children_tree_branch_obj_vec):-1:1
            error_bound
...
%                 %tree_node_obj.children_tree_branch_obj_vec(i) = set_min_error_estimated_current_branch(tree_node_obj.children_tree_branch_obj_vec(i));
                ...
                tree_node_obj.children_tree_branch_obj_vec(i).child_tree_node_right_obj = traverse_tree_branch_and_bound2(tree_node_obj.children_tree_branch_obj_vec(i).child_tree_node_right_obj);
                ...
                tree_node_obj.children_tree_branch_obj_vec(i).child_tree_node_left_obj = traverse_tree_branch_and_bound2(tree_node_obj.children_tree_branch_obj_vec(i).child_tree_node_left_obj);
                ...
                traceBack_unit_obj = set_traceBack_unit(traceBack_unit_obj,sub_app_unit_obj_left,sub_app_unit_obj_right,app_unit_obj);
                %disp('--------------------');
